...
Partial Public Class Menu
    ...
    Sub menu()
        ...
        Else
            ...
            Dim dbcomm, dbcomm2, dbcomm3 As SqlCommand
            Dim dtread, dtread2, dtread3 As SqlDataReader
            ...
            Dim command As String = "select distinct b.IDMenu,UserName " &
                                    ...
                                    "where EmployeeID = '" & Session("EMPLNUMBER") & "' and Flag = 1"
            ...
            Try
                ...
                For x As Integer = 1 To Jumlah
                    ...
                    If Not dtread.IsDBNull(dtread.GetOrdinal("UserName")) Then
                        ...
                        Dim dt As DataTable
                        dt = oSelect.f_CheckMMenus(Session("EMPLNUMBER"), Label_Menu, Session("Entity"))
                        Dim jumlahMenu = dt.Rows(0)("Jumlah").ToString()

                        If jumlahMenu = 1 Then
                            Dim mymenus As New MenuItem
                            Dim dtd As DataTable
                            dtd = oSelect.f_CheckMMenu(Session("EMPLNUMBER"), Label_Menu, Session("Entity"))
                        ...
                        ElseIf jumlahMenu > 1 Then
                            ...
                            dts = oSelect.f_CheckMMenu(Session("EMPLNUMBER"), Label_Menu, Session("Entity"))
