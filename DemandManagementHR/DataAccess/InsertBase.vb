...
#Region "Constanta"
    ...
    Dim const_SP_DEPART As String = "SP_DEPART"
#End Region
    Public Function f_DEPART(ByVal DEPART As String)

        Dim oParam(0) As SqlParameter

        oParam(0) = New SqlParameter("@DEPART", Data.SqlDbType.VarChar)
        oParam(0).Value = CType(DEPART, String)

        Dim _connectionString As String = _connectionString_AFI

        Return (ExecuteNonQuery(_connectionString, const_SP_DEPART, Data.CommandType.StoredProcedure, oParam))
    ...
    Public Function f_INS_UPD_MST_EMPLOYEE(ByVal EMPID As String, ByVal EMPNAME As String,
                                           ...
                                           ByVal AREA As String, ByVal EMAILMANAGER As String,
                                           ByVal HIRED As Date, ByVal EXPIRED As Date,
                                           ByVal DURATION As Int32, ByVal STATUS As String, ByVal FLAG As Int32,
                                           ByVal CREATED_BY As String, ByVal UPDATED_BY As String, ByVal idx As String, ByVal UPLOADID As Int32, ByVal COMMAND As String,
                                           ByVal WORKER_TYPE As String, ByVal NATIONALITY As String)
        ...
        oParam(5) = New SqlParameter("@EMAILMANAGER", Data.SqlDbType.VarChar)
        oParam(5).Value = CType(EMAILMANAGER, String)
        ...
        oParam(14) = New SqlParameter("@UPLOADID", Data.SqlDbType.Int)
        oParam(14).Value = CType(UPLOADID, Int32)

        oParam(15) = New SqlParameter("@COMMAND", Data.SqlDbType.VarChar)
        oParam(15).Value = CType(COMMAND, String)

        oParam(16) = New SqlParameter("@WORKER_TYPE", Data.SqlDbType.VarChar)
        oParam(16).Value = CType(WORKER_TYPE, String)

        oParam(17) = New SqlParameter("@NATIONALITY", Data.SqlDbType.VarChar)
        oParam(17).Value = CType(NATIONALITY, String)
    ...
    Public Function f_INSERT_MST_EMPLOYEE_FAILED(ByVal JOINDATE As String, ByVal ENDDATE As String, ByVal DURATION As Integer,
                                                 ByVal STATUS As String, ByVal EMOPLOYEEID As String, ByVal EMPLOYEENAME As String, ByVal TITLE As String,
                                                 ByVal DEPARTMENT As String, ByVal ENTITY As String, ByVal EMAILMANAGER As String, ByVal EMAILHRSERVICES As String,
        ...
        oParam(5) = New SqlParameter("@EMOPLOYEENAME", Data.SqlDbType.VarChar)
        oParam(5).Value = CType(EMPLOYEENAME, String)
