...
#Region "Constanta"
    Dim const_sp_InsertLogin As String = "sp_INSERT_LOGIN_NEW"
    ...
    Dim const_SP_CHECK_EROR As String = "SP_CHECK_EROR"
    ...
    Dim const_SP_SEL_USERMATRIX As String = "SP_SEL_USERMATRIX"


#End Region
    Public Function f_CHECK_EROR(ByVal NO As Int32) As DataTable

        Dim dt As New DataTable
        Dim oParam(0) As SqlParameter

        oParam(0) = New SqlClient.SqlParameter("@NO", SqlDbType.Int)
        oParam(0).Value = CType(NO, Int32)

        Dim _connectionString As String = _connectionString_AFI
        dt = FillDataset(_connectionString, const_SP_CHECK_EROR, CommandType.StoredProcedure, oParam)
    ...
    Public Function f_MST_EMPLOYEE() As DataTable
        ...
        Dim _connectionString As String = _connectionString_AFI
        dt = FillDataset(_connectionString, const_sp_SEL_QUARTER_LOAD, CommandType.StoredProcedure)

        Return dt

    End Function
    Public Function f_UserMatrix() As DataTable

        Dim dt As New DataTable

        Dim _connectionString As String = _connectionString_AFI
        dt = FillDataset(_connectionString, const_SP_SEL_USERMATRIX, CommandType.StoredProcedure)
    ...
    Public Function f_SEL_MST_EMPLOYEE_LOAD() As DataTable
        ...
        Dim _connectionString As String = _connectionString_AFI
        dt = FillDataset(_connectionString, const_sp_SEL_MST_EMPLOYEE_LOAD, CommandType.StoredProcedure)

        Return dt
    End Function
    Public Function f_InsertLogin(ByVal _userid As String, ByVal _ip As String, ByVal EMPLID As String) As DataTable
    ...
    Public Function f_CheckMMenus(ByVal emplid As String, ByVal _MenuID As String, ByVal _entity As String) As DataTable
        Dim dt As New DataTable
    ...
    Public Function f_SEL_LIST_EMPL(ByVal EMPLID As String, ByVal EMPLNAME As String,
                                    ByVal FLAGEMPLID As String, ByVal FLAGEMPLNAME As String, ByVal ROLE As String,
                                    ByVal ID_USER As String, ByVal ENTITY As String) As DataTable
        ...
        oParam(4) = New SqlClient.SqlParameter("@ROLE", SqlDbType.VarChar)
        oParam(4).Value = CType(ROLE, String)

        oParam(5) = New SqlClient.SqlParameter("@ID_USER", SqlDbType.VarChar)
        oParam(5).Value = CType(ID_USER, String)

        oParam(6) = New SqlClient.SqlParameter("@ENTITY", SqlDbType.VarChar)
        oParam(6).Value = CType(ENTITY, String)
    ...
    End Function
    Public Function f_SEL_MST_NOTIF(ByVal Nationality As String) As DataTable

        Dim dt As New DataTable
        Dim oParam(0) As SqlParameter

        oParam(0) = New SqlClient.SqlParameter("@Nationality", SqlDbType.VarChar)
        oParam(0).Value = CType(Nationality, String)

        Dim _connectionString As String = _connectionString_AFI
        dt = FillDataset(_connectionString, const_sp_SEL_MST_NOTIF, CommandType.StoredProcedure, oParam)
