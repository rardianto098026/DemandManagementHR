...
#Region "Constanta"
    ...
    Dim const_SP_DEL_MST_EMPLOYEE As String = "SP_DEL_MST_EMPLOYEE"
...
#End Region
    ...
    Public Function Del_CASHBACK_GRIDVEIW(ByVal PAYDETAILS As String, ByVal CLAIMNO As String,
    ...
    'End Function
    Public Function f_Del_MST_EMPLOYEE(ByVal IDX As String) As Integer
        ...
        int_i = ExecuteNonQuery(_connectionString, const_SP_DEL_MST_EMPLOYEE, CommandType.StoredProcedure, oParam)
