...
<body onbeforeUnload="bodyUnload();" onclick="clicked=true;" oncontextmenu="return false">
    ...
    <div>
        ...
        <asp:Label runat="server" Visible="false" ID="lblENTER" autopostback="true"></asp:Label>
              <br /> 
               <h1 align="center"> Update Notification Email <asp:Label ID="lblupdate" runat="server"></asp:Label></h1>
            <table width="1200px" align="center" cellpadding="0" cellspacing="0">
                        <tr>
         ...
         <div style='overflow:auto;width:1200px;text-align:center;margin:0 auto';align="center">
                                    <asp:gridview ID="dgListEditNotif" runat="server"
                                     AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC"
                                     BorderStyle="None" BorderWidth="1px" CellPadding="1" CssClass="tDatagridITReview"
                                     Height="100%" AllowSorting="True" PageSize="10" AllowPaging="true" OnRowCommand="dgListEditNotif_RowCommand"
                                     Width="100%">
                            ...
                            <Columns>	
                                <asp:TemplateField HeaderStyle-Width="10px" HeaderText="EDIT">
                                     <ItemTemplate>
                                          <asp:ImageButton ID="ImageButton1" runat="server" CommandName="cmdEdit" CommandArgument="<%# Container.DataItemIndex %>"
								...
								<asp:BoundField  DataField="EmployeeID" HeaderText="Employee ID" HeaderStyle-Width="100px" Visible="true">
                                <HeaderStyle Width="100px"></HeaderStyle>
                                </asp:BoundField>
                                
                                <asp:BoundField  DataField="EmployeeName" HeaderText="Employee Name" HeaderStyle-Width="100px"  Visible="true">
                                <HeaderStyle Width="100px"></HeaderStyle>
                                </asp:BoundField>
                                ...
                                <asp:BoundField  DataField="JoinDate" HeaderText="Join Date" HeaderStyle-Width="10px" Visible="true">
                                <HeaderStyle Width="10px"></HeaderStyle>
                                </asp:BoundField>
                                
                                <asp:BoundField  DataField="EndDate" HeaderText="Expiry Date" HeaderStyle-Width="100px" Visible="true">
                                <HeaderStyle Width="100px"></HeaderStyle>
                                </asp:BoundField>
