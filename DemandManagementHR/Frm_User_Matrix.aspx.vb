...
Partial Class Frm_User_Matrix
    ...
    Public Sub check()
        ...
        Try
            ...
            ssql = "SELECT a.UserName,b.IDMenuChild FROM dbo.MST_USER_MATRIX a " & _
                    "inner join MST_MENU_CHILD b on a.IDMenuChild = b.IDMenuChild " & _
                    "where UserName = '" & txtUserName.Text & "' and flag = 1" & _
                    "order by b.Idx"
            ...
            For Each RootNode As TreeNode In TreeView1.Nodes
                For Each Lists As TreeNode In RootNode.ChildNodes
                    If Lists.Checked = True Then
                        ...
                        ssql = "SELECT	* FROM dbo.MST_USER_MATRIX where UserName = '" & txtUserName.Text & "' and IDMenuChild = '" & Lists.Value & "' and flag = 1"
                        ...
                        If Not objDR.HasRows = True And flag = "2" Then
                            'oInsert.f_Insert_User_Matrix(UserName, Lists.Value, CreatedBy, Entity)
                    ...
                    ElseIf Lists.Checked = False Then
                        ...
                        If objDR.HasRows Then
                            'oInsert.f_Edit_User_Matrix(UserName, Lists.Value, CreatedBy, Entity)
