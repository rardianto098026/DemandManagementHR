...
Public Class Usermatrix
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Dim emplnum = Session("EMPLNUMBER").ToString
            dtlogin = oSelect.f_InsertLogin(Session("UserID").ToString, LocalHostaddress, Session("EMPLNUMBER").ToString)
        Catch ex As Exception
            'Exit Sub
    ...
    Sub LoadEmployee()
        ...
        dtEmployee = oSelect.f_SEL_MST_EMPLOYEE_LOAD()
    ...
    Public Sub check()
        ...
        Try
            ...
            ssql = "SELECT a.UserName,b.IDMenuChild FROM dbo.MST_USER_MATRIX a " &
                    ...
                    "where EmployeeID = '" & txtUserName.SelectedValue & "' and flag = 1" &
                    "order by b.Idx"
