        ...
        Try
            ...
            If dtImport.Rows.Count > 0 Then
                ...
                For Each dr As DataRow In dtImport.Rows
                    ...
                    oInsert.f_INSERT_MST_EMPLOYEE(dr("HIRE DATE").ToString, dr("CONTRACT EXPIRE DATE").ToString, dr("DURATION (MONTH)").ToString, dr("STATUS").ToString, dr("EMPLOYEE ID").ToString,
                                                 dr("EMPLOYEE NAME").ToString, dr("AREA NAME").ToString, dr("DEPARTMENT").ToString, dr("ENTITY").ToString, dr("MANAGER").ToString,
                                                 dr("HR").ToString, uploadid,
                                                 Session("UserID").ToString)
