...
#End Region
    ...
    Public Function f_SEL_GET_COUNT_EMPLOYEE(ByVal EmployeeID As String, ByVal EmployeeName As String, ByVal HiredDate As String) As DataTable
        ...
        oParam(2) = New SqlClient.SqlParameter("@HiredDate", SqlDbType.VarChar)
        oParam(2).Value = CType(HiredDate, String)
