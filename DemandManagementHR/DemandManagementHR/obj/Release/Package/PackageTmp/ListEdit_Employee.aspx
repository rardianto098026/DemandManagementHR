    ...
    <div>
         <table width="1200px" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <br /> 
               <h1 align="center"> List Edit Employee <asp:Label ID="lblupdate" runat="server"></asp:Label></h1>
            <table width="1200px" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                         ...
                         <div style='overflow:auto;width:1000px;text-align:center;margin:0 auto';align="center">
                                ...
                                <asp:BoundField  DataField="EndDate" HeaderText="Expired Date" HeaderStyle-Width="100px" SortExpression="EndDate ASC" Visible="true">
