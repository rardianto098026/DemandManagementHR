...
Partial Public Class PopUpEmpl
    ...
    Sub ListNotif()
        Dim dtS, dtS2 As New DataTable
        dtS2 = oSelect.f_SEL_DETAIL_MST_EMPL(Session("IDX").ToString)
        lblNationality2.Text = dtS2.Rows(0)("Nationality").ToString()
        dtS = oSelect.f_SEL_MST_NOTIF(lblNationality2.Text)
    ...
    Sub ListDataBind()
        Try
            ...
            If dtS.Rows.Count > 0 Then
                ...
                lblworkertype2.Text = dtS.Rows(0)("WorkerType").ToString()
                lblNationality2.Text = dtS.Rows(0)("Nationality").ToString()
                ...
                If dtS.Rows(0)("FlagTwoMonth").ToString() <> 0 Then
                    chkbx.Items.FindByText("2 Month").Selected = True
                End If
                ...
                'If lblNationality2.Text = "Expatriate" Then
                '    If dtS.Rows(0)("FlagFourMonth").ToString() <> 0 Then
                '        chkbx.Items.FindByText("4 Months").Selected = True
                '    End If
                '    If dtS.Rows(0)("FlagFiveMonth").ToString() <> 0 Then
                '        chkbx.Items.FindByText("5 Months").Selected = True
                '    End If
                '    If dtS.Rows(0)("FlagSixMonth").ToString() <> 0 Then
                '        chkbx.Items.FindByText("6 Months").Selected = True
                '    End If
                '    If dtS.Rows(0)("FlagSevenMonth").ToString() <> 0 Then
                '        chkbx.Items.FindByText("7 Months").Selected = True
                '    End If
                'End If
    ...
    Private Sub btnBack_Click(sender As Object, e As EventArgs) Handles btnBack.Click
        Response.Redirect("Frm_List_Empl.aspx")
    End Sub
End Class